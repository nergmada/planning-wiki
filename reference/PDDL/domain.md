...
- [:strips](./Domain/requirements#STRIPS)
- [:typing](./Domain/requirements#typing)
- [:disjunctive-preconditions](./Domain/requirements#Disjunctive%20Preconditions)
- [:equality](./Domain/requirements#Equality)
- [:existential-preconditions](./Domain/requirements#Existential%20Preconditions)
- [:universal-preconditions](./Domain/requirements#Universal%20Preconditions)
- [:quantified-preconditions](./Domain/requirements#Quantified%20Preconditions)
- [:conditional-effects](./Domain/requirements#Conditional%20Effects)
- [:action-expansions](./Domain/requirements#Action%20Expansions)
- [:foreach-expansions](./Domain/requirements#Foreach%20Expansions)
- [:dag-expansions](./Domain/requirements#DAG%20Expansions)
- [:domain-axioms](./Domain/requirements#Domain%20Axioms)
- [:subgoal-through-axioms](./Domain/requirements#Subgoals%20Through%20Axioms)
- [:safety-constraints](./Domain/requirements#Safety%20Constraints)
- [:expression-evaluation](./Domain/requirements#Expression%20Evaluation)
- [:fluents](./Domain/requirements#Fluents)
- [:open-world](./Domain/requirements#Open%20World)
- [:true-negation](./Domain/requirements#True%20Negation)
- [:adl](./Domain/requirements#ADL)
- [:ucpop](./Domain/requirements#UCPOP)
